...
import com.xuecheng.paysystem.alipay.trade.model.builder.AlipayHeartbeatSynRequestBuilder;
import com.xuecheng.paysystem.alipay.trade.model.builder.AlipayTradePayRequestBuilder;
...
import com.xuecheng.paysystem.alipay.trade.model.hb.EquipStatus;
import com.xuecheng.paysystem.alipay.trade.model.hb.ExceptionInfo;
import com.xuecheng.paysystem.alipay.trade.model.hb.HbStatus;
import com.xuecheng.paysystem.alipay.trade.model.hb.PosTradeInfo;
import com.xuecheng.paysystem.alipay.trade.model.hb.Product;
import com.xuecheng.paysystem.alipay.trade.model.hb.SysTradeInfo;
import com.xuecheng.paysystem.alipay.trade.model.hb.Type;
...
import com.xuecheng.paysystem.alipay.trade.service.AlipayMonitorService;
import com.xuecheng.paysystem.alipay.trade.service.AlipayTradeService;
import com.xuecheng.paysystem.alipay.trade.service.impl.AlipayMonitorServiceImpl;
import com.xuecheng.paysystem.alipay.trade.service.impl.AlipayTradeServiceImpl;
import com.xuecheng.paysystem.alipay.trade.service.impl.AlipayTradeWithHBServiceImpl;
...
public class Main {
    ...
    // 测试当面付2.0查询订单
    public void test_trade_query(String tradeNo) {
        ...
        AlipayTradeQueryResponse re = result.getResponse();
        System.out.println("-----订单查询返回参数:"+JSON.toJSONString(re));
        switch (result.getTradeStatus()) {
            case SUCCESS:
