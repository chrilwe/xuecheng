    ...
    <div class="article-banner">
        ...
        <div class="banner-info">
            <div class="banner-left">
                <p class="tit"><#if model??>${(model[0].mapValue)['courseInfo'].name}</#if></p>
                <p class="pic"><span class="new-pic">特惠价格￥<#if model??>${(model[0].mapValue)['courseInfo'].price}</#if></span> <span class="old-pic">原价￥<#if model??>${(model[0].mapValue)['courseInfo'].price_old}</#if></span></p>
                <p class="info">
                    <a href="/course/learning/101" target="_blank">马上学习</a>
                    <span><em>难度等级</em><#if model??>${(model[0].mapValue)['courseInfo'].grade}</#if></span>
                    <span><em>课程时长</em><#if model??>${(model[0].mapValue)['course_total_time']}</#if></span>
                    <span><em>评分</em>4.7分</span>
                    <span><em>授课模式</em><#if model??>${(model[0].mapValue)['courseInfo'].teachmode}</#if></span>
                </p>
            </div>
                        ...
                        <div class="content">
                            ...
                            <div class="content-com suit">
                                ...
                                <div class="cont cktop">
                                    <div >
                                        <p><#if model??>${(model[0].mapValue)['courseInfo'].users</#if></p>
                                    </div>
