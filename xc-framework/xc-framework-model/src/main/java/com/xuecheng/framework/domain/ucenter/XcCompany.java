...
public class XcCompany implements Serializable {
	...
	public String toString() {
		return "XcCompany [id=" + id + ", name=" + name + ", logo=" + logo + ", intro=" + intro + ", email=" + email
				+ ", mobile=" + mobile + ", linkname=" + linkname + ", identitypic=" + identitypic + ", worktype="
				+ worktype + ", businesspic=" + businesspic + ", status=" + status + "]";
	}
